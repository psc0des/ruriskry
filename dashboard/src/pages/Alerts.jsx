...
export default function Alerts() {
  ...
  const isFiltered   = filterStatus !== 'all' || filterSeverity !== 'all' || searchText
  const displaySet   = isFiltered ? filtered : alerts
  const activeCount  = displaySet.filter(a => a.status === 'pending' || a.status === 'investigating').length
                ...
                if (isSingle) {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-2.5 text-center">
                        {(alert.status === 'resolved' || alert.status === 'investigated') ? (
